...
experiment Explo_TMD_base type: batch repeat:200 keep_seed: true  until: (Annee >= fin_simulation){
	parameter 'save_TMD' var: save_TMD init: true;
	parameter 'prefix' var: prefix_output init: "base";
}

experiment Explo_TMD_paroisses parent: "Explo_TMD_base" type: batch repeat:200 keep_seed: true until: (Annee >= fin_simulation){
	parameter 'prefix' var: prefix_output init: "paroisses";
	parameter 'ratio_paroissiens_agregats' var: ratio_paroissiens_agregats init: 75;
}

experiment Explo_TMD_gros_chateaux parent: "Explo_TMD_base" type: batch repeat:200 keep_seed: true until: (Annee >= fin_simulation){
	parameter 'prefix' var: prefix_output init: "gros_chateaux";
	parameter "proba_promotion_groschateau_multipole" var: proba_promotion_groschateau_multipole init: 0.75;
	parameter "proba_promotion_groschateau_autre"  var: proba_promotion_groschateau_autre init: 0.25;
}

experiment Explo_TMD_dist_dem_local parent: "Explo_TMD_base" type: batch repeat:200 keep_seed: true until: (Annee >= fin_simulation){
	parameter 'prefix' var: prefix_output init: "distdemlocal";
	parameter "distance_max_dem_local" var: distance_max_dem_local init: 5000;
}

experiment Explo_TMD_attrac_poles parent: "Explo_TMD_base" type: batch repeat:200 keep_seed: true until: (Annee >= fin_simulation){
	parameter 'prefix' var: prefix_output init: "attrac_poles";
	
	parameter "attrac_0_eglises" var: attrac_0_eglises init: 0.0;
	parameter "attrac_1_eglises" var: attrac_1_eglises init: 0.05;
	parameter "attrac_2_eglises" var: attrac_2_eglises init: 0.25;
	parameter "attrac_3_eglises" var: attrac_3_eglises init: 0.55;
	parameter "attrac_4_eglises" var: attrac_4_eglises init: 0.65;
	parameter "attrac_GC" var: attrac_GC init: 0.35;
	parameter "attrac_PC" var: attrac_PC init: 0.05;	
}
 
 experiment Explo_TMD_base2 parent: "Explo_TMD_attrac_poles" type: batch repeat:200 keep_seed: true until: (Annee >= fin_simulation){
	parameter 'prefix' var: prefix_output init: "base2";
	// Idem attrac_poles sauf :
	
	// Seuil de paroissiens nécessaire à la création d’une nouvelle paroisse en agrégat : 200
	parameter 'ratio_paroissiens_agregats' var: ratio_paroissiens_agregats init: 200;
	
	// Augmenter seuil de FP insatisfait pour promotion église : passer de 5 à 10 FP
	parameter 'nb_paroissiens_mecontents_necessaires' var: nb_paroissiens_mecontents_necessaires init: 10;
	...
	parameter "proba_promotion_groschateau_multipole" var: proba_promotion_groschateau_multipole init: 0.8;
	parameter "proba_promotion_groschateau_autre"  var: proba_promotion_groschateau_autre init: 0.3;
 ...
 experiment Explo_TMD_base2_test2 parent: "Explo_TMD_base2" type: batch repeat:15 keep_seed: true until: (Annee >= fin_simulation){
	parameter 'prefix' var: prefix_output init: "base2_test3";
	// Idem Explo_TMD_base2
}


 experiment Explo_TMD_base2_compo5_2 parent: "Explo_TMD_base2" type: batch repeat:20 keep_seed: true until: (Annee >= fin_simulation){
	parameter 'prefix' var: prefix_output init: "base2_compo5_2";
	// Idem Explo_TMD_base2 sauf :	
	...
	parameter "nb_chateaux_potentiels_GS" var: nb_chateaux_potentiels_GS init: 2;
	parameter "chateaux_GS_alternate" var: chateaux_GS_alternate init: true;
	parameter "puissance_necessaire_creation_chateau_GS" var: puissance_necessaire_creation_chateau_GS init: 1000;
	...
	parameter "chateaux_PS_alternate" var: chateaux_PS_alternate init: true;
	parameter "puissance_necessaire_creation_chateau_PS" var: puissance_necessaire_creation_chateau_PS init: 0;
	
	// Distance max. de déménagement local des FP : 2.5 km.
	parameter "distance_max_dem_local" var: distance_max_dem_local init: 2500;
	...
	parameter "puissance_armee_FP_alternate" var: puissance_armee_FP_alternate init: true;
}

experiment Explo_TMD_base2_compo5_2bis parent: "Explo_TMD_base2_compo5_2" type: batch repeat:20 keep_seed: true until: (Annee >= fin_simulation){
	parameter 'prefix' var: prefix_output init: "base2_compo5_2bis";
	// Idem Explo_TMD_base2_compo5_2 sauf :
...
experiment Explo_TMD_base2_compo5_2ter parent: "Explo_TMD_base2_compo5_2bis" type: batch repeat:20 keep_seed: true  until: (Annee >= fin_simulation){
	parameter 'prefix' var: prefix_output among: ["base2_compo5_2ter"];
	// Idem Explo_TMD_base2_compo5_2bis sauf :
	...
	parameter "nb_chateaux_potentiels_GS" var: nb_chateaux_potentiels_GS init: 3;
	...
	parameter "communautes_attractives" var: communautes_attractives init: true;
	parameter "attrac_communautes" var:attrac_communautes init: 0.10;	
	...
	parameter "deplacement_alternate" var: deplacement_alternate init: true;
	
	// Attractivité des pôles  : prendre les valeurs plus différenciées
	parameter "attrac_1_eglises" var: attrac_1_eglises init: 0.10; // etait à 0.05

	parameter "attrac_PC" var: attrac_PC init: 0.10; // Etait à 0.05
}



experiment Explo_TMD_base2_compo5_2_5 parent: "Explo_TMD_base2_compo5_2ter" type: batch repeat:20 keep_seed: true until: (Annee >= fin_simulation){
	parameter 'prefix' var: prefix_output init: "base2_compo5_2_5";
	// Idem Explo_TMD_base2_compo5_2ter
}




experiment Explo_TMD_base2_compo5_2_6  parent: "Explo_TMD_base2_compo5_2ter" type: batch repeat:20 keep_seed: true until: (Annee >= fin_simulation){
	parameter 'prefix' var: prefix_output init: "base2_compo5_2_6";
	// Idem Explo_TMD_base2_compo5_2ter sauf :
	
	// Seuil de paroissiens nécessaire à la création d’une nouvelle paroisse en agrégat : 300
	parameter 'ratio_paroissiens_agregats' var: ratio_paroissiens_agregats init: 300;
	
	// Augmenter seuil de FP insatisfait pour promotion église : passer de 10 à 20 FP
	parameter 'nb_paroissiens_mecontents_necessaires' var: nb_paroissiens_mecontents_necessaires init: 20;

	// Changement distance max dem local
	parameter "distance_max_dem_local" var: distance_max_dem_local init: 4000;
	
	//Modification à apporter au modèle :
	// deux (et non trois) tirages successifs de probabilité de construire un château pour les grands seigneurs
	parameter "nb_chateaux_potentiels_GS" var: nb_chateaux_potentiels_GS init: 2;
	
	
	// Attractivité des pôles  : on change encore
	parameter "attrac_1_eglises" var: attrac_1_eglises init: 0.05; // Etait 0.10
	parameter "attrac_GC" var: attrac_GC init: 0.15; // Etait 0.35
}
...
experiment Exp_debug type: gui {
	...
	parameter "nb_chateaux_potentiels_GS" var: nb_chateaux_potentiels_GS init: 2;
	parameter "communautes_attractives" var: communautes_attractives init: true;
	parameter "attrac_communautes" var:attrac_communautes init: 0.1;	
	parameter "deplacement_alternate" var: deplacement_alternate init: true;
	...
	parameter "attrac_3_eglises" var: attrac_3_eglises init: 0.55;
	parameter "attrac_4_eglises" var: attrac_4_eglises init: 0.65;
	parameter "attrac_GC" var: attrac_GC init: 0.15;
	parameter "attrac_PC" var: attrac_PC init: 0.1;	
	
	parameter "agregats_alternate" var: agregats_alternate init: true;
	parameter "poles_alternate" var: poles_alternate init: true;
	parameter "agregats_alternate2" var: agregats_alternate2 init: true;
	parameter "recompute_agregats_at_end" var: recompute_agregats_at_end init: true;
}


experiment "Explo_TMD_base3_1" parent: "Explo_TMD_base2_compo5_2_6" type: batch repeat:20 keep_seed: true until: (Annee >= fin_simulation){
	parameter 'prefix' var: prefix_output init: "base3_1";
	// Idem Explo_TMD_base2_compo5_2_6 sauf :

	// Changement règles constitution agrégats et pôles
	parameter "agregats_alternate" var: agregats_alternate category: "Seigneurs" init: true;
	parameter "poles_alternate" var: poles_alternate category: "Seigneurs" init: true;
}


experiment "Explo_TMD_base3_2" parent: "Explo_TMD_base3_1" type: batch repeat:20 keep_seed: true until: (Annee >= fin_simulation){
	parameter 'prefix' var: prefix_output init: "base3_2";
	// Idem Explo_TMD_base3_1 sauf :
	
	// Ajout règle agrégats
	parameter "agregats_alternate2" var: agregats_alternate2 init: true;
	
	// On re-calcule/définit les agrégats en fin de tour, pour que les FP soient bien comptabilisés
	parameter "recompute_agregats_at_end" var: recompute_agregats_at_end init: true;
}