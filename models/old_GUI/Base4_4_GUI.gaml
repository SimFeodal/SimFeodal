...
experiment Exp_4_4_A type: batch repeat: 20 keep_seed: false until: (Annee >= fin_simulation){
	parameter 'save_outputs' var: save_outputs init: true;
	parameter 'prefix' var: prefix_output init: "4_4_A";
	parameter "benchmark" var: benchmark init: false; // Changement pour connaitre perfs fonctions
}

experiment Exp_4_4_B type: batch repeat: 2 keep_seed: false until: (Annee >= fin_simulation){
...
experiment Exp_4_4_C type: batch repeat: 4 keep_seed: false until: (Annee >= fin_simulation){
...
experiment Exp_4_4_D type: batch repeat: 2 keep_seed: false until: (Annee >= fin_simulation){
