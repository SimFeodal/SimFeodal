	...
	action save_Parameters {
		if (!file_exists(Param_file)){
			save ["Année début simulation", "Année fin simulation", "Nombre de Foyers Paysans","Taux renouvellement",
				...
				"Châtelain peut créer château", "Proba. gain droits haute justice sur château", 
				"Proba. gain droits banaux sur château","Proba. gain droits BM Justice sur château",
				"Probabilité créer château PS", "Probabilité don château PS", "Proba. don droits sur ZP",
			...
			save [debut_simulation, fin_simulation, nombre_foyers_paysans, taux_renouvellement, taux_mobilite,
				...
				chatelain_cree_chateau, proba_gain_droits_hauteJustice_chateau, proba_gain_droits_banaux_chateau,
				proba_gain_droits_basseMoyenneJustice_chateau, proba_creer_chateau_PS, proba_don_chateau_PS,
